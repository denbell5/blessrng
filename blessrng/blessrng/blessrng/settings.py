"""
Django settings for blessrng project.
...
ALLOWED_HOSTS = ['.localhost', '127.0.0.1', 'blessrng.grok.vlabs.knu.ua']
...
WSGI_APPLICATION = 'blessrng.wsgi.application'
# Database
# https://docs.djangoproject.com/en/2.1/ref/settings/#databases
DATABASES = sensitive_config.DATABASES
